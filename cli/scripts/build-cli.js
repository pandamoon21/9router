...
function buildCliPackage() {
  ...
  // Windows keeps handles on freshly-built files, so a hard delete can fail with
  // EBUSY/EPERM. cleanPathForRebuild retries, then moves the dir aside to .app-trash.
